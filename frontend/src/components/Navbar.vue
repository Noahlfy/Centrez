...
<template>
    <div>
        <div id="nav_container">
            <nav>
                <ul>
                    ...
                    <li class="deroulant"><a href="#" @click.prevent="ouvrirOnglet('Comptabilite')">Comptabilité</a>
                        <ul class="sous">
                            <li><a @click="ouvrirOnglet('GrandLivre')">Grand Livre</a></li>
                            <li><a @click="ouvrirOnglet('Saisie')">Saisie</a></li>
                            <li><a @click="ouvrirOnglet('Cheques')">Chèques</a></li>
                        </ul>
                    </li>
                    <li class="deroulant"><a href="#" @click.prevent="ouvrirOnglet('Budget')">Budget</a>
                        <ul class="sous">
                            <li><a @click="ouvrirOnglet('Global')">Global</a></li>
                            <li><a @click="ouvrirOnglet('Evenement')">Evenement</a></li>
                            <li><a @click="ouvrirOnglet('References')">Références</a></li>
                        </ul>
                    </li>
                    <li class="deroulant"><a href="#" @click.prevent="ouvrirOnglet('PiecesJustificatives')">Pièces justificatives</a>
                        <ul class="sous">
                            <li><a @click="ouvrirOnglet('')"></a></li>
                            <li><a @click="ouvrirOnglet('')"></a></li>
                            <li><a @click="ouvrirOnglet('')"></a></li>
                        </ul>
                    </li>
                    <li class="deroulant"><a href="#" @click.prevent="ouvrirOnglet('EditionDeDocuments')">Edition de documents</a>
                        <ul class="sous">
                            <li><a @click="ouvrirOnglet('')"></a></li>
                            <li><a @click="ouvrirOnglet('')"></a></li>
                            <li><a @click="ouvrirOnglet('')"></a></li>
                    ...
                    <li class="deroulant"><a href="#" @click.prevent="ouvrirOnglet('Juridique')">Juridique</a>
                        <ul class="sous">
                            <li><a @click="ouvrirOnglet('')"></a></li>
                            <li><a @click="ouvrirOnglet('')"></a></li>
                            <li><a @click="ouvrirOnglet('')"></a></li>
                    ...
                    <li class="deroulant"><a href="#" @click.prevent="ouvrirOnglet('Documentation')">Documentation</a>
                        <ul class="sous">
                            <li><a @click="ouvrirOnglet('')"></a></li>
                            <li><a @click="ouvrirOnglet('')"></a></li>
                            <li><a @click="ouvrirOnglet('')"></a></li>
        ...
        <div id="fenetres">
            <div id="onglets">
                <div v-for="tab in tabs" :key="tab.name" :class="['tab-button', { active: currentTab === tab.name }]" @click="currentTab = tab.name">
                    <span> {{ tab.name }} </span>
                    <button v-if=" !(tabList.find(t => t.name === tab.name )?.fixed)" id="fermer-onglet" @click.stop="fermerOnglet(tab.name)">x</button>
                </div>
            </div>
            <component v-if="tabs.find(t => t.name === currentTab)" :is="tabs.find(t => t.name === currentTab)?.component" class="tab"></component>
        </div>
    </div>
</template>
